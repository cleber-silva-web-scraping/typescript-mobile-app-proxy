...
var getToken = function (_a) {
    var chave = _a.chave, crypted = _a.crypted;
    return __awaiter(void 0, void 0, void 0, function () {
        var url, headers, data, response, tokens, token, instalacao, dados, quitadas;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    data = "client_id=agencia-virtual-cpfl-app&grant_type=instalacao_app&identificacao_encriptada=".concat(crypted);
                    return [4 /*yield*/, (0, node_fetch_1.default)(url, { method: 'POST', body: data, headers: headers })];
                case 1:
                    response = _b.sent();
                ...
                case 2:
                    ...
                    instalacao = JSON.parse(tokens['Instalacao']);
                    dados = {
                        ...
                        identificacao_encriptada: "".concat(crypted)
                    };
                    quitadas = {
                    ...
                    return [2 /*return*/, { chave: chave, token: token, histBody: dados, quitBody: quitadas }];
            }
        });
    });
};
